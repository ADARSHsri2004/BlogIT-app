...
const BlogPage = () => {
  ...
  const isAuthor = user?.id === blog.author?._id || user?.id === (blog.author as any)?.id;

  return (
    <MainLayout>
      <article className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white px-6 py-8 shadow-sm dark:border-slate-700 dark:bg-slate-800">
